...
<head>
    ...
    <title>B.C.A Applicants - File Checking</title>
    <link rel="stylesheet" href="../styles.css">
</head>
<body>
    <h1>File Checking for Students Who Applied for B.C.A</h1>

    <?php 
     include("C:/xampp/htdocs/my_project/config/config.php");
    $sql="SELECT id, name, photo, signature, transfer, 
    aadharfile, tenthmarksheet, twelfthmarksheet, community FROM information WHERE course1='bca' OR course2='bca' OR course3='bca'";
    ...
    <br>
    <a href="bca_course_info.php">Next: Course Details -></a>
</body>
</html>
