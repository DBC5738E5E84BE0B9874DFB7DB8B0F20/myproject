...
<head>
    ...
    <title>B.C.A Applicants - Course Details</title>
...
<body>
    ...
    $sql = "SELECT id, course1,shiftoption1, course2,shiftoption2,
     course3 ,shiftoption3 FROM information WHERE course1='bca' OR course2='bca' OR course3='bca'";
...
;
    ...
    <br>
    <a href="approved_students_bca.php">APPROVED STUDENTS PAGE</a>
</body>
</html>
