...
<head>
    ...
    <title>B.B.A Applicants - Course Details</title>
    <link rel="stylesheet" href="../styles.css">
</head>
<body>
    <h1>Course Details of Students Who Applied for B.B.A</h1>

    <?php 
    include("C:/xampp/htdocs/my_project/config/config.php");
    $sql = "SELECT id, course1,shiftoption1, course2,shiftoption2,
     course3 ,shiftoption3 FROM information WHERE course1='bba' OR course2='bba' OR course3='bba'";
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<td><a href='approval_bca.php?id=".$row["id"]."'>Approve</a></td>";
;
            echo "</tr>";
        }
        echo "</table>";
    ...
    <br>
    <a href="approved_students_bba.php">APPROVED STUDENTS PAGE</a>
</body>
</html>
