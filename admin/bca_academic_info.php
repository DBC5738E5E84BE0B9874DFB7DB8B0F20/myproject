...
<head>
    ...
    <title>B.C.A Applicants - Academic Information</title>
    <link rel="stylesheet" href="../styles.css">
</head>
<body>
    <h1>Academic Information of Students Who Applied for B.C.A</h1>

    <?php 
     include("C:/xampp/htdocs/my_project/config/config.php");
    $sql="SELECT id, tenthboard, tenthschool, tenthpassingyear, tenthpercentage, twelfthboard, twelfthschool, twelfthpassingyear, subject1, marks1, subject2, marks2, subject3, marks3, subject4, marks4 FROM information WHERE course1='bca' OR course2='bca' OR course3='bca'";
    ...
    <br>
    <a href="bca_file_check.php">Next: File Checking -></a>
</body>
</html>
