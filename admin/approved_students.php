...
$sql = "SELECT id, name, application_id, email, phone FROM information WHERE status='approved'";
$result = $conn->query($sql);

// Fetch available seats
$seat_check_sql = "SELECT available_seats FROM seats WHERE course_name='bcom'";
