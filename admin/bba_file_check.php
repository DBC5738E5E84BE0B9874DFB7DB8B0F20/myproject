...
<head>
    ...
    <title>B.B.A Applicants - File Checking</title>
    <link rel="stylesheet" href="../styles.css">
</head>
<body>
    <h1>File Checking for Students Who Applied for B.B.A</h1>

    <?php 
     include("C:/xampp/htdocs/my_project/config/config.php");
    $sql="SELECT id, name, photo, signature, transfer, 
    aadharfile, tenthmarksheet, twelfthmarksheet, community FROM information WHERE course1='bba' OR course2='bba' OR course3='bba'";
    ...
    <br>
    <a href="bba_course_info.php">Next: Course Details -></a>
</body>
</html>
