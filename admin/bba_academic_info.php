...
<head>
    ...
    <title>B.B.A Applicants - Academic Information</title>
    <link rel="stylesheet" href="../styles.css">
</head>
<body>
    <h1>Academic Information of Students Who Applied for B.B.A</h1>

    <?php 
     include("C:/xampp/htdocs/my_project/config/config.php");
    $sql="SELECT id, tenthboard, tenthschool, tenthpassingyear, tenthpercentage, twelfthboard, twelfthschool, twelfthpassingyear, subject1, marks1, subject2, marks2, subject3, marks3, subject4, marks4 FROM information WHERE course1='bba' OR course2='bba' OR course3='bba'";
    ...
    <br>
    <a href="bba_file_check.php">Next: File Checking -></a>
</body>
</html>
