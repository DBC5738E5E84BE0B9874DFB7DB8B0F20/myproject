...
if(isset($_GET['id'])) {
    ...
    if ($row) {
        ...
        echo "<center><form method='POST' action=''>
                <table border='1'>
                    <tr><center><th colspan='5'>Personal Information</th></center></tr>
                    <tr>
                        <td>Name: {$row['name']}</td>
                        <td>DOB: {$row['dob']}</td>
                ...
                <table border='1'>
                    <tr><center><th colspan='5'>Academic Information</th></center></tr>
                    <tr>
                ...
                <table border='1'>
                    <tr><th colspan='7'><center>Uploaded Files</center></th></tr>
                    <tr>
 ...
 <br><br>               <input type='hidden' name='student_id' value='{$row['id']}' />
